...
# sitl = None
# vehicle = connect('tcp:192.168.1.52:3333', wait_ready=True)
# height = -33.6
# height = -(50.03-43.88)
# height = -9
...
def get_lat_lon(lat0, lon0, h0, e1, n1, u1):
  # if((e1 * n1) > 0):
  #     e1 = e1 * -1
  #     n1 = n1 * -1
  # e1 = 80,n1 = 30
  lat1, lon1, h1 = pymap3d.enu2geodetic(e1, n1, u1, lat0, lon0, h0, ell=None, deg=True)
  return lat1[0], lon1[0]
...
def find_lat_lon(lat, lon, pitch, roll, yaw, f, fx, fy, cx, cy, u, v, angle, height):
  # u = 10
  # v = 10
  rec = Rec(pitch+angle, roll, yaw)
  pimt = Pcimt(f, fx, fy, cx, cy, u, v)
  abspimt = absPcimt(pimt)
  d = cald(height, rec, pimt, abspimt)
  # print(angle, d)
  enu_frame = Pet(rec, d, pimt, abspimt)
  return get_lat_lon(lat, lon, height, enu_frame[0], enu_frame[1], enu_frame[2])

# lat2 = 13.847478258048547
# lon2 = 100.56481686231754
# 13.84623626074483, 100.56851401961089
# print(find_lat_lon(f, fx, fy, cx, cy, u, v, angle, height))
...
# height = -9
# for i in range(10):
#   u, v = randint(0,600), randint(0,600)
#   print('u:', u)
#   print('v:', v)
#   print(find_lat_lon(f, fx, fy, cx, cy, u, v, angle,height))
